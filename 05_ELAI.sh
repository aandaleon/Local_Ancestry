...
if [[ -f $NAT && $CEU && $YRI ]]; then
    ...
    (/usr/bin/time -v ./elai-lin -g $dir/sim_ELAI/${out}_NAT.recode.geno.txt -p 10 -g $dir/sim_ELAI/${out}_CEU.recode.geno.txt -p 11 -g $dir/sim_ELAI/${out}_YRI.recode.geno.txt -p 12 -g $dir/sim_ELAI/${out}.recode.geno.txt -p 1 -pos $dir/sim_ELAI/${out}.recode.pos.txt -o ${out}) 2> $dir/sim_ELAI/results/${out}_benchmarking.txt
elif [[ -f $NAT && $CEU ]]; then
