...
pop_names <- c("MXL_pruned", "MXL_thinned", "PUR_pruned", "PUR_thinned", "ACB_pruned", "ACB_thinned", "ASW_pruned", "ASW_thinned", "EVEN_pruned", "EVEN_thinned", "BRYC_pruned", "BRYC_thinned") #should be the only part that changes
for(pop_name in pop_names){
  if(pop_name %in% c("MXL_pruned", "MXL_thinned", "PUR_pruned", "PUR_thinned")){
    ancs <- c("NAT", "CEU")
  }else if(pop_name %in% c("ACB_pruned", "ACB_thinned", "ASW_pruned", "ASW_thinned")){
    ancs <- c("CEU", "YRI")
  }else{
    ancs <- c("NAT", "CEU", "YRI")
  }
